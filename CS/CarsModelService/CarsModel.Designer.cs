...
namespace CarsModelService
{
    ...
    /// </summary>
    public partial class CarsModelEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new CarsModelEntities object using the connection string found in the 'CarsModelEntities' section of the application configuration file.
        /// </summary>
        public CarsModelEntities() : base("name=CarsModelEntities", "CarsModelEntities")
        {
        ...
        /// </summary>
        public CarsModelEntities(string connectionString) : base(connectionString, "CarsModelEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new CarsModelEntities object.
        /// </summary>
        public CarsModelEntities(EntityConnection connection) : base(connection, "CarsModelEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CarsModelModel", Name="Car")]
    [Serializable()]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CarsModelModel", Name="CarScheduling")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
